...
public interface LessonService {
    ...
    Lesson create(String title, String description, Category category,
                  Level level, String urlPhoto, String urlVideo, Quiz quiz);
    Lesson update(Long id, String title, String description, Long category,
                  Level level, String urlPhoto, String urlVideo, Quiz quiz);
